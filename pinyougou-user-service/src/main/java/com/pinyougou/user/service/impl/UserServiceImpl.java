...
public class UserServiceImpl implements UserService {
	...
	public void createSmsCode(final String phone) {		
		...
		jsmTemplate.send(smsDestination,new MessageCreator() {
			...
			public Message createMessage(Session session) throws JMSException {
				 ...
				 Map m=new HashMap<>();
				 m.put("code", code);
				 message.setString("param", JSON.toJSONString(m));			 
				 return message;
	 ...
	 */
	@Override
	public boolean checkSmSIsRight(String code,String phone) {
		String redisCode = (String) redisTemplate.boundHashOps("smscode").get(phone);
		System.out.println("缓存中的： "+redisCode+"num"+phone);
		if(redisCode==null) {
			return false;
		}
